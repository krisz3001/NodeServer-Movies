...
function newItem(img, title, desc){
    return `<div class="col-sm-4 col-lg-3 col-6 p-0 item"><img src="assets/${img}" class="img-fluid border border-secondary"><div class="item-info d-none bg-dark p-2 border border-secondary w-100 rounded-bottom"><p class="h5">${title}</p><a class="btn btn-success w-100" target="_blank" href="https://www.youtube.com/watch?v=RWSnR2oKR5o">Play</a><p class="text-justify m-0">${desc}</p></div></div>`
}
function refresh(){
